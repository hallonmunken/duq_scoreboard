...
AddEventHandler('esx:playerLoaded', function(player)
	...
	MySQL.Async.fetchAll('SELECT firstname, lastname FROM characters WHERE id = @identifier', {
		...
		if result[1] ~= nil then
			...
			TriggerClientEvent("esx:showNotification", src, "Something happend with your character when it was trying to load into the scoreboard - duq_scoreboard")
		end
...
print("Scoreboard made by duqaqon")